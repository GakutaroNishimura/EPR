...
ChSync=4                    #channel of the sync out from the function generator
ChTrigger=ChSync
...
ModulationFreq=8001       #Hz Modulation frequency
...
iDeltaFreq=1e6*0.2 #iFreq*0.03  #Hz Initial amplitude of the deviation 
Voltage=20           #Volt
N_wave=3
